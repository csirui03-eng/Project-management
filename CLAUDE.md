...
- When John asks for something drafted into one of his notes (a table, a list, a reference block), show the draft in chat first and write it to the note only on his word. His own narrated sentences fold in directly.
