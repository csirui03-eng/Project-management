...
method: dget
group: inqfun
source: PyMAPDL 0.74.1 docstrings, pandoc 3.9.0.2, ansys.mapdl.core._commands.inq_func.inq_function.dget
...
PyMAPDL: `mapdl.dget(node, idf, kcmplx, pname='__tmpvar__', **kwargs)`
...
`float`: Constraint value (High number if undefined)
