...
method: grp
group: solution
source: PyMAPDL 0.74.1 docstrings, pandoc 3.9.0.2, ansys.mapdl.core._commands.solution.spectrum_options.SpectrumOptions.grp
...
PyMAPDL: `mapdl.grp(signif='', label='', forcetype='', **kwargs)`
...
The `SIGNIF` value set with this command (including the default value of 0.001) overrides the `SIGNIF` value set with the [[mxpand|MXPAND]] command.

This command is also valid for PREP7.

Ansys help: https://ansyshelp.ansys.com/Views/Secured/corp/v232/en//ans_cmd/Hlp_C_GRP.html
